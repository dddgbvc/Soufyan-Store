...
|---|---|---|
| `auth-flows` | البوابة، البابان، الدخول برمز صحيح وخاطئ، الهوية والصلاحيات من الخادم، ما يُكتب وما لا يُكتب في المتصفح، الاستئناف والرفض، الخروج، تبديل المستخدم، مفتاح المرور، البريد ورمزه | 34 |
...
| `interface` | ثمانية عروض من 360 إلى 1920 بلا فيض أفقي، مساحات اللمس، لوحة المفاتيح وترتيب التركيز وحصره، المظهر الداكن، الإنجليزية و LTR، تقليل الحركة، وقياس التباين على كل نص جديد | 26 |
| `failures` | انقطاع الشبكة، الإيقاف بعد محاولات كثيرة، غياب الربط بالخادم، الوضع المحلي، مهلة السماح والرفض الصريح، ونقل التخزين إلى جهاز آخر | 18 |
